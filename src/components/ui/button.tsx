  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "hero-gradient text-primary-foreground font-semibold shadow-primary hover:scale-105 transition-bounce",
        accent: "accent-gradient text-secondary-foreground font-semibold shadow-secondary hover:scale-105 transition-bounce",
        minimal: "bg-background text-foreground border border-border hover:bg-accent hover-lift",
        glass: "glass-card text-foreground font-medium hover:scale-105 transition-smooth backdrop-blur-sm",
      },
      size: {
